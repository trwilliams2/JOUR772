...
ggplot(pg_calls_with_income, aes(x=estimate, y=total_calls))+ geom_point() + labs(title = 'Wealthier areas of PG county have fewer 911 overdose calls', x = 'Median income', y= 'Total calls') +
  
  geom_text(aes(x=estimate,y=total_calls, label=zipcode, check_overlap = TRUE, size=2))
