...
**A3.** The top primary vote-getting Republicans and Democrats are missing. Yes. Getting coding errors on last question.
...
**A5.** Getting errors but I assume that not all the spending on Facebook has been properly labeled.
