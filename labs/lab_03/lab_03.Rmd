...
A2: 2020; 2016 and most recent years are missing. Question so far: Is that because of records not captured in the above filter or another reason?
...
A3. Cleaning will require fixing typos, abbreviations and space/punctuation issues. Examples:
...
str_sub function may help to change spaces and punctuation. Not sure how to handle the abbreviation or typo issues.
...
A4: Funding appears to have decreased by a lot from 2009 to 2010, and then noisily trended downward.
