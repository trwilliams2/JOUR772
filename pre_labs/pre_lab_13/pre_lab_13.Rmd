...
**Task** Run the following code and describe the dataframe it outputs. **Answer** A table of the above columns.
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer** There is a lot of spread, but generally higher growth states have higher population change.
...
**Task** Run the following code. Describe the plot. What do you see? **Answer** A lot of spread and no clear correlation.
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer** A numeric representation of the correlations in the graphs above.
...
**Task** Run the following code. Describe the model output. What do you see? **Answer** Data for the t-test and p value for correlation of per pupil spending and population change, which show a strong correlation.
...
**Task** Run the following code. Describe the model output. What do you see? **Answer** The p value here for correlation of education spending and gdp growth is much larger and suggests a lack of correlation.
...
**Task** Run the following code. Describe the table. What do you see? **Answer** This shows a table of mean gdp growth, per pupil spending and population change for Biden-voting states versus Trump-voting states.
...
**Task** Run the following code. Describe the output. What do you see? **Answer** For population change versus Biden or Trump, t test shows somewhat weak correlation.
...
**Task** Run the following code. Describe the output. What do you see? **Answer** A strong correlation between per pupil spending versus Biden or Trump vote. But that could be caused by many factors, perhaps chiefly that Democratic-leaning states tend to support more spending on education.
