...
Answer: 60712 observations of 8 variables
...
In the space below, write the data type for the "id" column and the "seats" column (it's in light gray, offset by \< \>). Answer: id: <chr>; seats: <dbl>
...
Answer: (Summarize) Counting number of classes (group by) offered in each term
