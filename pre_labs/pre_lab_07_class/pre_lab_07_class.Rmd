...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer** Howard County ($129,549) 
...
Is the difference between Calvert and Montgomery significant? **Answer** Likely no, because of the overlap.
