...
**Task** Load the four CSV population estimate files. Do they have the same column structure? **Answer** Yes, with names cleaned at least.
...
```{r}
# bind_rows with list (will stack the lists)
...
**Task** Run the following code to change the datatype of ZCTA5N from numeric to character. What's the datatype of ZCTA5N? **Answer** Zip code data (now as character).
