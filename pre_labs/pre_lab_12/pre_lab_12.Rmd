...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** "Critical" is maybe neither positive nor negative, as some of these may be statements like "critical investments" etc.
