...
Now let's repeat the steps we did to import the PDF into Tabula, go to page 67.[Page 64?] It should look like this:
...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer: The column names aren't showing up correctly, and we have a header we don't want ("maryland).**
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer: No headers, extra punctuation.**
...
**Task** Run the codeblock below. What else do we need to do? **Answer: Get rid of the periods in the jurisdictions.**
