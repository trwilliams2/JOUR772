...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer: Charles County is an outlier in foreclosure notices. Montgomery, Howard and Frederick have relatively few compared to neighboring counties. Properties in counties neighboring Baltimore also seem to have a moderate or low rate of foreclosures. Higher rates in the southern bay area.**
